...
- Post-`v0.16` focused UX/function pass:
  ...
  - added card-based weather/climate layout polish and stronger semantic button styling
  - theme utility row now uses practical controls (`Acc+`, `Th-`, icon mode, theme next)
